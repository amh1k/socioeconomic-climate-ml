...
\begin{table}[h!]
    ...
    \begin{tabular}{lcccccc}
        ...
        Decision Tree & -0.0195 & 0.668 & 0.9823 & $2.15 \times 10^7$ & 0.2814 & 0.15\,s \\
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Decision Tree baseline} achieves reasonable CO$_2$ performance (R$^2$ = 0.982) with minimal training time (0.15\,s), demonstrating that even simple non-linear models capture emission dynamics better than linear approaches.
...
\begin{table}[h!]
    ...
    \begin{tabular}{lccccc}
        ...
        \textbf{CO$_2$ R$^2$} & 0.27 & 0.982 & 0.996 & 0.989 & 0.990 \\
        \textbf{Temp R$^2$} & 0.001 & -0.020 & -0.013 & -0.028 & -0.025 \\
        \textbf{Train Time} & 0.23\,s & 0.15\,s & 142\,s & 0.91\,s & 0.76\,s \\
